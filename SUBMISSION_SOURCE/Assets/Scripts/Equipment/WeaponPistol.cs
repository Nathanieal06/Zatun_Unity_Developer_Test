// Assets/Scripts/Equipment/WeaponPistol.cs
using UnityEngine;

/// <summary>
/// Pistol weapon — hitscan fire will be added Day 3.
/// </summary>
public class WeaponPistol : WeaponBase
{
    ...
    protected override void Awake()
    {
        ...
        if (maxMagazine <= 0) maxMagazine = 7;

        base.Awake();
        attackRate = 0.4f; // Slower than rifle
    ...
    public override bool Attack(Transform origin)
    {
        ...
        Debug.Log($"[Pistol] Bang! Ammo left in mag: {currentMagazine}/{maxMagazine}");
        ...
        Debug.DrawRay(fireOrigin, fireDirection * range, Color.red, 2f);
